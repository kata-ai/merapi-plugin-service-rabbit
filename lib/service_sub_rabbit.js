...
class ServiceSubRabbit extends ServiceSub {
    ...
    constructor(config, logger, injector, amqp, servicePubRabbit) {
        ...
        this.servicePubRabbit.on("changeConnection", async(function* (conn) {
            this.amqp = conn;
    ...
    *initialize() {
        ...
        let consumerPrefetch = this.config.default("service.rabbit.consumerPrefetch", this.config.default("service.rabbit.prefetch", prefetch));
